...
(async () => {
    ...
    cloudContainer.scale = 1;
    cloudContainer.pivot.set(cloudContainer.width / 2, cloudContainer.height / 2);
    cloudContainer.position.set(app.screen.width / 2, app.screen.height / 2);
    app.stage.addChild(cloudContainer);

    const balloonContainer = new Container();
    if (app.screen.width > 700) { balloonContainer.scale = 1.5 }
    else { balloonContainer.scale = 0.7 }
    ...
    balloonContainer.y = app.screen.height / 2 + 20;

    const bgTexture = await Assets.load('/images/background.png');
    const bg = new Sprite(bgTexture);
    bg.anchor.set(0.5, 1);
    bg.position.set(app.screen.width / 2, app.screen.height);
    bg.scale = 1;
    ...
    const starTwinkle = () => {
        ...
        star1.position.y += 0.07;
        star1.rotation += 0.00002;
        alphaPhase += 0.005;
    ...
    satelite.anchor.set(0.5);
    satelite.position.set(app.screen.width / 2 + satelite.width / 2, -(app.screen.height / 2 - 100));
    cloudContainer.addChild(satelite);

    const satMoving = () => {
        satelite.position.x -= 0.5;
        satelite.position.y += 0.10;
        satelite.rotation += 0.0001;
        if (satelite.position.x < -(app.screen.width + satelite.width)) {
    ...
    moon1.anchor.set(0.5);
    moon1.position.set(app.screen.width / 2 + moon1.width / 2, -(app.screen.height / 2 - 200));
    cloudContainer.addChild(moon1);

    const moon1Moving = () => {
        moon1.position.x -= 0.25;
        moon1.position.y += 0.08;
        if (moon1.position.x < -(app.screen.width + moon1.width)) {
    ...
    cloud1.position.set(-100, -(cloud1.height + app.screen.height / 2));
    cloud1.scale = 3;
    ...
    cloud2.position.set(200, -(cloud2.height + app.screen.height / 2 + 250));
    cloud2.scale = 3;
    ...
    cloud3.position.set(-0, -(cloud3.height + app.screen.height / 2));
    cloud3.scale = 5;
    cloud3.alpha = 0.8;
    ...
    cloud4.position.set(250, -(cloud4.height + app.screen.height / 2));
    cloud4.alpha = 0.8;
    ...
    cloud5.position.set(-200, -(cloud5.height + app.screen.height / 2));
    cloud5.alpha = 0.8;
    ...
    cloud6.position.set(300, -(cloud6.height + app.screen.height / 2));
    cloud6.alpha = 0.8;
    cloudContainer.addChild(cloud6);

    const movingCloud1 = () => {
        cloud1.position.y += 1;
        cloud1.position.y -= 0.04;
        if (cloud1.position.y > (cloud1.height + app.screen.height / 2)) {
            cloud1.position.set(-100, -(cloud1.height + app.screen.height / 2));
    ...
    const movingCloud2 = () => {
        ...
        if (cloud2.position.y > (cloud2.height + app.screen.height / 2)) {
            cloud2.position.set(200, -(cloud2.height + app.screen.height / 2));
            app.ticker.remove(movingCloud2);
        }
    }
    const movingCloud3 = () => {
        cloud3.position.y += 0.8;
        cloud3.position.x -= 0.06;
        if (cloud3.position.y > (cloud3.height + app.screen.height / 2)) {
            cloud3.position.set(-0, -(cloud3.height + app.screen.height / 2));
    ...
    const movingCloud4 = () => {
        ...
        if (cloud4.position.y > (cloud4.height + app.screen.height / 2)) {
            cloud4.position.set(250, -(cloud4.height + app.screen.height / 2));
            app.ticker.remove(movingCloud4);
        }
    }
    const movingCloud5 = () => {
        cloud5.position.y += 0.71;
        cloud5.position.x -= 0.05;
        if (cloud5.position.y > (cloud5.height + app.screen.height / 2)) {
            cloud5.position.set(-200, -(cloud5.height + app.screen.height / 2));
    ...
    const movingCloud6 = () => {
        cloud6.position.y += 1;
        if (cloud6.position.y > (cloud6.height + app.screen.height / 2)) {
            cloud6.position.set(300, -(cloud6.height + app.screen.height / 2));
    ...
    moon2.position.set((app.screen.width + moon2.width) / 2 + 100, -(app.screen.height / 2 - 200));
    moon2.scale = 2;
    cloudContainer.addChild(moon2);

    const moon2Moving = () => {
        moon2.position.x -= 0.3;
        moon2.position.y += 0.1;
        if (moon2.position.x < -(app.screen.width + moon2.width)) {
    ...
    rock1.position.set(app.screen.width / 4, -(app.screen.height / 2 + rock1.height / 2));
    rock1.anchor.set(0.5);
    cloudContainer.addChild(rock1);

    const rock1Moving = () => {
        rock1.position.x -= 0.1;
        rock1.position.y += 0.2;
        rock1.rotation += 0.002;
        if (rock1.position.x < -(app.screen.width + rock1.width)) {
    ...
    balloonPart.position.set(-45, 33);
    ...
    socket.onmessage = (event) => {
        ...
        if (data.type === "roundStarts") {
            ...
            moon1.position.set(app.screen.width / 2 + moon1.width / 2, -(app.screen.height / 2 - 100));
            app.ticker.remove(moon1Moving);

            moon2.position.set(app.screen.width / 2 + moon2.width / 2, -(app.screen.height / 2 - 200));
            app.ticker.remove(moon2Moving);
...
document.querySelector('.settingsRowColumn.history').addEventListener('click', () => {
    document.querySelector('.crashplay-layout-mobile-left-ls').classList.remove("hidden");
})
document.querySelector('.close-mobile-panel').addEventListener('click', () => {
    document.querySelector('.crashplay-layout-mobile-left-ls').classList.add("hidden");
})
